      ...
      <div ref={ref} className="container">
        ...
        <div className={`max-w-md mx-auto transition-all duration-300 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
          <form ref={form} className="space-y-4" onSubmit={sendEmail}>
            <Input name="user_name" placeholder="Name" className="bg-input focus:border-ring border-border transition-colors duration-300" required/>
            <Input name="user_email" type="email" placeholder="Email" className="bg-input focus:border-ring border-border transition-colors duration-300" required/>
            <Textarea name="message" placeholder="Message" className="bg-input focus:border-ring border-border h-28 transition-colors duration-300" required/>
            <Button
              type="submit"
